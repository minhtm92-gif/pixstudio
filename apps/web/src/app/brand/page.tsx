...
const ASSET_SECTIONS: AssetSection[] = [
	{
		title: "Symbol",
		description:
			"Use the symbol on its own when the PixStudio name is already present nearby or space is limited.",
		cols: "2",
		assets: [
			{
				src: "/logos/pixstudio/symbol.svg",
				theme: "dark",
				label: "Symbol",
				width: 400,
				height: 400,
			...
			{
				src: "/logos/pixstudio/symbol-light.svg",
				theme: "light",
				label: "Symbol",
				width: 400,
				height: 400,
	...
	},
	{
		...
		assets: [
			...
			{
				src: "/logos/pixstudio/logo-light.svg",
				theme: "light",
				label: "Logo",
				width: 1809,
				height: 400,
			...
			{
				src: "/logos/pixstudio/text-light.svg",
				theme: "light",
				label: "Text",
				width: 1760,
				height: 400,
...
export default function BrandPage() {
	return (
		<BasePage
			...
			description={
				<>
					Download PixStudio brand assets for use in your projects.{" "}
					<Link
						href="#guidelines"
			...
			<div id="guidelines" className="flex flex-col gap-8 text-sm">
				<div className="flex flex-col gap-3">
					...
					<p className="text-muted-foreground text-base leading-relaxed">
						PixStudio is open source â€” the code is free to use under its license.
						That license does not cover the name or logo. You can say you use
						PixStudio, that your project integrates with PixStudio, or that it was
						built on top of PixStudio. You cannot name your product PixStudio, imply
						we made or endorse your product, or use the marks commercially
						without asking first. For anything unclear, reach out at{" "}
						<Link
							href="mailto:brand@studio.pixelxlab.com"
							className="underline underline-offset-4"
						>
							brand@studio.pixelxlab.com
						</Link>
						.
					</p>
				</div>
				...
				<div className="flex flex-col gap-3">
					...
					<ul className="text-muted-foreground text-base flex flex-col gap-2 leading-relaxed">
						{[
							"Using PixStudio in the name of your product, service, or domain.",
							"Implying that PixStudio made, sponsors, or endorses your work.",
