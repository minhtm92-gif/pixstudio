...
const roadmapItems: RoadmapItem[] = [
	...
	},
	{
		...
		description:
			"Native PixStudio apps for Mac, Windows, Linux, and iOS/Android.",
		status: {
			text: "Not started",
			type: "default",
		},
...
export const metadata: Metadata = {
	title: "Roadmap - PixStudio",
	description:
		"See what's coming next for PixStudio - the free, open-source video editor that respects your privacy.",
	openGraph: {
		title: "PixStudio Roadmap - What's Coming Next",
		description:
			"See what's coming next for PixStudio - the free, open-source video editor that respects your privacy.",
		type: "website",
		images: [
...
export default function RoadmapPage() {
	return (
		<BasePage
			title="Roadmap"
			description={`What's coming next for PixStudio (last updated: ${LAST_UPDATED})`}
		>
			<div className="mx-auto flex max-w-4xl flex-col gap-16">
				...
				<GitHubContributeSection
					title="Want to help?"
					description="PixStudio is open source and built by the community. Every contribution,
